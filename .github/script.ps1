...
$apiUrl = "https://api.modrinth.com/v2/project/Qy0Keq7s/version"
...
$headers = @{
    "User-Agent" = "ThievishJoke/Hanas-Enchantments (GitHub Actions)"
}
...
if ($version_id -ne $previous_version_id) {
    ...
    $url = "https://modrinth.com/datapack/hanas-enchantments/version/$version_id"
